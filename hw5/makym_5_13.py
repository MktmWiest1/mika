...
result_file_path4 = 'name.txt'

file_reader4 = open(file_path4,mode='r',encoding="Latin-1")
final_results4 = open(result_file_path4,mode='w',encoding="Latin-1")
...
s1 = r"[A-Z]+[a-z]+\w+[.]+[a-z]+[0-9]|[A-Z]+[a-z]+\w+[.]+[a-z]+|[A-Z]+[a-z]+[.]+[a-z]+[0-9]|[A-Z]+[a-z]+[.]+[a-z]+|[A-Z]+[a-z]+[.]+[a-z]+|[A-Z]+[.]+[a-z]+|[A-Z]+[.]+[a-z]+[0-9]" \
